window.onload = function () {
    ...
    var plane = new Image();
    plane.src = 'resources/game/plane.png';
    var bird = new Image();
    bird.src = 'resources/game/bird.png'
    var birdhit = new Image();
    birdhit.src = 'resources/game/birdhit.png'
    var angel = new Image();
    angel.src = 'resources/game/angel.png'
    var angelhit = new Image();
    angelhit.src = 'resources/game/angelhit.png'
    var rocket = new Image();
    rocket.src = 'resources/game/rocket.png'
    var rockethit = new Image();
    rockethit.src = 'resources/game/rockethit.png'
    var meteor = new Image();
    meteor.src = 'resources/game/meteor.gif'
    var end = new Image();
    end.src = 'resources/game/end.png';
